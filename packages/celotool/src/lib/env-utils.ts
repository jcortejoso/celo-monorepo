...
export enum envVar {
  ...
  ORACLE_PRIMARY_ADDRESSES_FROM_MNEMONIC_COUNT = 'ORACLE_PRIMARY_ADDRESSES_FROM_MNEMONIC_COUNT',
  ...
  ORACLE_SECONDARY_ADDRESSES_FROM_MNEMONIC_COUNT = 'ORACLE_SECONDARY_ADDRESSES_FROM_MNEMONIC_COUNT',
